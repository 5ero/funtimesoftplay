...
<template>
<div>
  <div class="bg-amber-50 md:pt-44">
    <div class="flex flex-col items-center">

      <div class="max-w-7xl mx-auto flex flex-col md:flex-row rounded-lg p-8 ">
        <div class="w-full">
          <h1 class="text-5xl font-bold">
            <span class="text-orange-600">Funtime Softplay</span></h1>
          <div class="md:hidden"><img src="/img/displays/PhotoRoom_20231123_153629.png" alt=""></div>
          <p class="prose text-xl leading-relaxed md:mt-4 text-gray-600">
            <span class="font-semibold text-2xl">Funtime Softplay</span>
...
<!--        <div class="hidden  md:block w-1/2 mr-8 pl-8 h-[700px]" style="background-position-y: -100px; background-size: cover; background-repeat: no-repeat; background-image: url('/img/displays/PhotoRoom_20231123_153629.png')"></div>-->
